...
define dso_local i32 @test_gep1() #0 {
    ...
    %1 = getelementptr inbounds %struct.ST, %struct.ST* %ptr, i64 0, i32 0
    %2 = load i32, i32* %1
...
define dso_local i64 @test_gep2() #0 {
    %ptr = alloca %struct.ST, align 8
    store %struct.ST { i32 1, i64 2, %struct.RT { i8 3, [2 x i32] [i32 4, i32 5], i8 6 } }, %struct.ST* %ptr
    %1 = getelementptr inbounds %struct.ST, %struct.ST* %ptr, i64 0, i32 1
    %2 = load i64, i64* %1
...
define dso_local i8 @test_gep3() #0 {
    %ptr = alloca %struct.ST, align 8
    store %struct.ST { i32 1, i64 2, %struct.RT { i8 3, [2 x i32] [i32 4, i32 5], i8 6 } }, %struct.ST* %ptr
    %1 = getelementptr inbounds %struct.ST, %struct.ST* %ptr, i64 0, i32 2, i32 0
    %2 = load i8, i8* %1
